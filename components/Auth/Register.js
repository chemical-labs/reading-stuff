            ...
            <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <View style={{ marginBottom: 30 }}>
                    <View >
                        ...
                        <TextInput placeholder="Password" style={{ padding: 8, borderRadius: 5, backgroundColor: '#ededed', width: 250, marginTop: 10 }} onChangeText={(val) => this.setState({ password: val })} secureEntryText={true} />

                        <TextInput placeholder="Phone Number" style={{ padding: 8, borderRadius: 5, backgroundColor: '#ededed', width: 250, marginTop: 10 }} onChangeText={(val) => this.setState({ phone: val })} />
                    </View>
